...
namespace TrainPro.Migrations
{
    ...
    [Migration("20231214150453_addOrderHeaderAndDetal")]
    partial class addOrderHeaderAndDetal
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TrainPro.Models.AppUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("TrainPro.Models.CartItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TrainPro.Models.MenuItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TrainPro.Models.OrderDetails", b =>
                {
            ...
            modelBuilder.Entity("TrainPro.Models.OrderHeader", b =>
                {
                    b.Property<int>("OrderHeaderId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TrainPro.Models.ShoppingCart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("TrainPro.Models.AppUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("TrainPro.Models.CartItem", b =>
                {
                    b.HasOne("TrainPro.Models.MenuItem", "MenuItem")
                        .WithMany()
                        .HasForeignKey("MenuItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("TrainPro.Models.ShoppingCart", null)
                        .WithMany("CartItems")
            ...
            modelBuilder.Entity("TrainPro.Models.OrderDetails", b =>
                {
                    ...
                    b.HasOne("TrainPro.Models.OrderHeader", null)
            ...
            modelBuilder.Entity("TrainPro.Models.OrderHeader", b =>
                {
                    b.HasOne("TrainPro.Models.AppUser", "User")
                        .WithMany()
